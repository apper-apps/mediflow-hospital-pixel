  ...
  return (
    ...
    <div className="flex items-center justify-between h-16 px-6 lg:px-8">
        ...
        <div className="flex items-center space-x-4">
            ...
            <div>
                <h1
                    className="text-xl font-bold bg-gradient-to-r from-slate-800 to-primary bg-clip-text text-transparent">
                    {currentPage.title}
                </h1>
        ...
        <div className="flex items-center space-x-4">
            ...
            {/* Status Indicator */}
            <div
                className="flex items-center space-x-2 px-3 py-1.5 bg-gradient-to-r from-success/10 to-success/20 border border-success/30 rounded-lg">
